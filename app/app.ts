		...
		function ($stateProvider, $urlRouterProvider) {
			...
			$stateProvider
				...
				.state("myInfo", {
					...
					controller: "ProjectListController as vm",
					resolve: {
						projectResource: "projectResource", /*works without this line*/
				...
				/*Project Edit Nested States  05_04: Nested Routing States*/
				...
				//-----| Show project details based on "projectId" using "resolve" object
				.state("projectDetail", {
